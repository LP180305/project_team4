    ...
    const handleRegister = (e) =>{
        ...
        if(email===""||password===""||userName===""||confirmPassword==="")
        {
            ...
            if(password!==confirmPassword){
                ...
                const user = account.find((item) => item.email === email && item.password === password)
                if (user){
                  setTimeout(() => {
                    setLoading(false)
      ...
      <div className="wrapper">
        <form onSubmit={handleRegister}>
          ...
          <div className="input-box">
            ...
            <FaUser style={{width:"30px",height:"30px"}} className="icon" />
          </div>
          <div className="input-box">
          ...
          <div className="input-box">
            ...
            <FaLock style={{width:"30px",height:"30px"}} className="icon" />
          </div>
          <div className="input-box">
